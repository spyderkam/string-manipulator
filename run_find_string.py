...
word = input("What is the string you want to find? ").lower()
o_or_m = input(f"Do you want to find the string '{word}' in just one file or multiple files with a specific extension? Enter 'o' for one or 'm' for multiple: ")
...
if o_or_m == 'o':
    ...
    if this_dir_yn == 'n':
        which_dir = input("Enter the path to the directory which the {ext} files are in: ")
